...
public final class StatPool {
    ...
    private static List<StatDef> createWeaponPool() {
        List<StatDef> pool = new ArrayList<>(List.of(
            ...
            new StatDef("experience",           PuffishAttributes.EXPERIENCE,           0.05, 0.20, "Experience Bonus",     "%"),
            new StatDef("critical_damage",      null,                                   0.10, 0.25, "Critical Damage",      "%"),
            new StatDef("execute_damage",       null,                                   0.08, 0.18, "Execution Damage",     "%"),
            ...
            new StatDef("repair_cost",          PuffishAttributes.REPAIR_COST,         -0.15,-0.05, "Repair Discount",      "%"),
            new StatDef("duelist_damage",       null,                                   0.05, 0.10, "Opening Damage",       "%"),
